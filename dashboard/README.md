...
Public guide to the dashboard as the main navigation and workflow surface for Orion Rigel users.
...
The Orion Rigel dashboard is the main operating surface for navigating collections, leads, scenarios, simulations, optimizations, and reporting tools.

## What Users Can Do

- Review current collections and recent activity.
...
2. Review the related leads or scenarios.
3. Open the analysis workflow that matches the task.
4. Compare outputs before using them in a decision.
